#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Compact window-state-gate residual-share curves by aridity class.
...
OUTPUT_CSV = "FIG3_compact_window_state_gate_residual_refined_data.csv"
OUTPUT_PNG = "FIG3_compact_window_state_gate_residual_refined.png"
OUTPUT_PDF = "FIG3_compact_window_state_gate_residual_refined.pdf"
OUTPUT_SVG = "FIG3_compact_window_state_gate_residual_refined.svg"

# Use white background for stable rendering in Word/PDF viewers.
...
# Keep colours identical across all Fig. 3 panels.
ARIDITY_COLORS = {
    "Hyperarid": "#9A7A2F",
    "Arid": "#D7A257",
    "Semiarid": "#9ECAE1",
...
# Add variable abbreviations for direct linkage with the main text.
DRIVERS = [
...
# Style
# =============================================================================
# Matched to revised Fig. 3a and CO2 panel.
BASE_FONT = 7.0
TICK_FONT = 6.3

# Slightly reduced because the x-axis labels are long.
AXIS_LABEL_FONT = 6.6
...
def main() -> None:
    ...
    # Slight horizontal offsets prevent overlap between
    # "(SM90)" and the following "Net-drying" label.
    xlabel_xpos = [
        0.500,
        0.475,
        0.525,
    ...
    # Plot panels
    # =========================================================================
    for idx, (ax, (driver, xlabel)) in enumerate(
        zip(axes, DRIVERS)
    ):
