...
OUTPUT_CSV = "FIG3_process_delta_window_gate_co2_highest_minus_lowest_data.csv"
OUTPUT_PNG = "FIG3_process_delta_window_gate_co2_highest_minus_lowest.png"
OUTPUT_PDF = "FIG3_process_delta_window_gate_co2_highest_minus_lowest.pdf"
OUTPUT_SVG = "FIG3_process_delta_window_gate_co2_highest_minus_lowest.svg"
...
# =============================================================================
FIGSIZE = (5.35, 2.95)
LEFT_AX_POS = [0.36, 0.255, 0.265, 0.635]
RIGHT_AX_POS = [0.68, 0.255, 0.265, 0.635]
BASE_FONT = 6.8
LABEL_FONT = 6.2
TICK_FONT = 6.1
AXIS_LABEL_FONT = 6.8
...
def main() -> None:
    ...
    plot_df = pd.concat([
        build_delta(p90, "P90_trend_qbin", "Water-supply window", "share_abs_co2_median"),
        build_delta(vpd, "VPD_resid_trend_qbin", "Drying gate", "share_abs_co2_median"),
    ], ignore_index=True)
    ...
    panels = ["Water-supply window", "Drying gate"]

    for ax, driver in zip(axes, panels):
    ...
    fig.text(
        shared_x,
        0.095,
        "Highest - lowest CO$_2$ share (percentage points)",
        ha="center",
        va="center",
