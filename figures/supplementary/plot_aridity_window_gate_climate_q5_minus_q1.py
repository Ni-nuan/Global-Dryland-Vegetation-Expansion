#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""End-member contrasts in climate share along window and gate gradients."""
...
OUTPUT_CSV = "FIG3_delta_window_gate_clim_highest_minus_lowest_data.csv"
OUTPUT_PNG = "FIG3_delta_window_gate_clim_highest_minus_lowest.png"
OUTPUT_PDF = "FIG3_delta_window_gate_clim_highest_minus_lowest.pdf"
OUTPUT_SVG = "FIG3_delta_window_gate_clim_highest_minus_lowest.svg"
...
def main() -> None:
    ...
    plot_df = pd.concat([endmember_contrast(df, d, "share_abs_clim") for d, _ in DRIVERS], ignore_index=True)
    ...
    for idx, (ax, (driver, panel_title)) in enumerate(zip(axes, DRIVERS)):
        ...
        ax.set_xlabel("Highest − lowest\nclimate share", fontsize=AXIS_LABEL_FONT, color=TEXT_COLOR, labelpad=4)
