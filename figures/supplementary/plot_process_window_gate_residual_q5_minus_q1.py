...
OUTPUT_CSV = "FIG3_process_delta_window_gate_residual_highest_minus_lowest_data.csv"
OUTPUT_PNG = "FIG3_process_delta_window_gate_residual_highest_minus_lowest.png"
OUTPUT_PDF = "FIG3_process_delta_window_gate_residual_highest_minus_lowest.pdf"
OUTPUT_SVG = "FIG3_process_delta_window_gate_residual_highest_minus_lowest.svg"
...
def main() -> None:
    ...
    plot_df = pd.concat([
        build_delta(p90, "P90_trend_qbin", "Water-supply window", "share_abs_res_median"),
        build_delta(vpd, "VPD_resid_trend_qbin", "Drying gate", "share_abs_res_median"),
    ], ignore_index=True)
    ...
    panels = [
        ("Water-supply window", "Highest - lowest residual share (percentage points)"),
        ("Drying gate", "Highest - lowest residual share (percentage points)"),
    ]
    ...
    fig.text(
        shared_x,
        0.095,
        "Highest - lowest residual share (percentage points)",
        ha="center",
        va="center",
